...
{
    steps{
        ansiblePlaybook become: true, credentialsId: 'ssh_key', disableHostKeyChecking: true, forks: 5, installation: 'Ansible', inventory: '/var/lib/jenkins/workspace/webhook_terraform/Terraform/hosts.ini', playbook: '/var/lib/jenkins/workspace/webhook_terraform/Ansible/first_playook.yml'
    }
}
